...
```{r}
# 2) Extração dos parâmetros dos modelos
...
# 3) Cálculo dos R² para cada modelo
df_aux <- vari_exp |>
  mutate(
...
tibble( #criando tibble com todos os resultados
  ...
  write_csv(paste0("../output/",paste(my_states,
                                            collapse = "_"), 
                   "-",my_year,"-nasa_temp.csv")) # MODIFICAR variável

ls_csv <- list.files("../output/",full.names = TRUE,pattern = "-nasa_temp.csv") # MODIFICAR
map_df(ls_csv, read_csv) |> 
  writexl::write_xlsx("../output/semivariogram-models-nasa_temp.xlsx") # MODIFICAR
```
